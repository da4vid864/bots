...
const Login = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Login | BotInteligente - Automatización de WhatsApp con IA</title>
        <meta name="description" content="Inicia sesión y prueba gratis la plataforma líder en automatización de WhatsApp con bots inteligentes, IA avanzada y analítica en tiempo real. Convierte más leads y escala tu negocio." />
        <meta name="keywords" content="WhatsApp, bots, automatización, inteligencia artificial, leads, ventas, CRM, chatbot, prueba gratis, BotInteligente" />
      </Helmet>
